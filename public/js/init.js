const BACK = '/api';
const PUBLISH_PRODUCT_URL = BACK + '/publish';
const CATEGORIES_URL = BACK + '/categories';
const CATEGORY_INFO_URL = BACK + '/category/5fc270b37e047b1a44320ba6';
const PRODUCTS_URL = BACK + '/products?cat=5fc270b37e047b1a44320ba6';
const PRODUCT_INFO_URL = BACK + '/info/5fc274ea7e047b1a44320baf';
const PRODUCT_INFO_COMMENTS_URL = BACK + '/comments/5fc274ea7e047b1a44320baf';
const CART_INFO_URL = BACK + '/cart';
const CART_BUY_URL = BACK + '/cart-buy';
...
var getJSONDataNS = function(url){
  var result = {};
  return fetch(url)
  .then(response => {
    if (response.ok) {
